...
public sealed class SqliteCommandTraceQuery : ICommandTraceQuery
{
        ...
        CancellationToken cancellationToken, ProductionStoreOptions options)
    {
        ...
        if (schemaVersion is not (1 or 2 or 3 or 4 or 5 or 6 or 7 or 8 or 9 or 10 or 11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 or 22 or 23 or 24 or 25 or 26 or 27 or 28 or 29 or 30 or 31 or 32 or 33 or 34 or 35)) throw new InvalidOperationException("StoreSchemaUnavailable");
        ...
        ProductionStoreOptions options, StoreDeadline deadline, CancellationToken cancellationToken)
    {
        ...
        var report = AuditChainDatabase.Verify(database, policy, key.KeyId,
            ...
            productionAdmissionOptions: options.ProductionAdmission,
                ...
                productionArmOptions: options.ProductionArming, recipeSelectionOptions: options.RecipeSelections, recipeLifecycleOptions: options.RecipeLifecycle, imageEvidenceOptions: options.ImageEvidence, imageFinalizationOptions: options.ImageFinalization);
