...
public sealed class SqliteRecipeTransferQuery : IRecipeTransferHistoryQuery
{
        ...
        StoreDeadline deadline, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            AuditChainDatabase.Require(schema is RecipeTransferStoreOptions.SchemaVersion or TraceStoragePolicyStoreOptions.SchemaVersion or QualificationCycleStoreOptions.SchemaVersion, "StoreSchemaTooNew");
