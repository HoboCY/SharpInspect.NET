...
internal sealed partial class SqliteCommandStore : ICommandAuditWriter, IAsyncDisposable
{
    ...
    private int SchemaVersion => ImageEvidenceEnabled ? ProductionImageEvidenceStoreOptions.SchemaVersion :
    ...
    private string MigrationReason(int existingVersion) => ImageEvidenceEnabled
        ...
        StoreDeadline? maintenanceDeadline = null, bool configureProfile = true)
    {
        ...
        if (version == ProductionImageEvidenceStoreOptions.SchemaVersion && !ImageEvidenceEnabled)
        ...
        if (_policy is not null)
        {
            ...
            if (version >= 2)
            {
                ...
                var lifecycleSchema = RecipeLifecycleEnabled &&
                    version is RecipeLifecycleStoreOptions.SchemaVersion or ProductionImageEvidenceStoreOptions.SchemaVersion;
