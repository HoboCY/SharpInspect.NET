...
internal sealed partial class SqliteCommandStore : ICommandAuditWriter, IAsyncDisposable
{
    ...
    private int SchemaVersion => EvidenceReconciliationEnabled ? EvidenceReconciliationStoreOptions.SchemaVersion :
        ...
        try
        {
            ...
            await foreach (var request in _queue.Reader.ReadAllAsync().ConfigureAwait(false))
            {
                ...
                else
                {
                    try
                    {
                        result = request.EvidenceReconciliation is { } reconciliation ? AppendEvidenceReconciliationCore(connection.Handle!, reconciliation, request.Deadline) :
    ...
    private string MigrationReason(int existingVersion) => EvidenceReconciliationEnabled
        ...
        StoreDeadline? maintenanceDeadline = null, bool configureProfile = true)
    {
        ...
        if (_policy is not null)
        {
                ...
                var verification = AuditChainDatabase.Verify(database, _policy, _signingKey.KeyId,
                    ...
                    calibrationSessionOptions: calibrationSchema ? _options.CalibrationSessions : null,
                     governanceOptions: _options.CalibrationGovernance,
                      ...
                      productionInspectionOptions: version is ProductionInspectionStoreOptions.SchemaVersion or PartIdentityStoreOptions.SchemaVersion or ProductionRecoveryStoreOptions.SchemaVersion or RecipeSelectionStoreOptions.SchemaVersion or ProductionArmStoreOptions.SchemaVersion or RecipeLifecycleStoreOptions.SchemaVersion or ProductionImageEvidenceStoreOptions.SchemaVersion or ProductionImageFinalizationStoreOptions.SchemaVersion or ProductionOutboxStoreOptions.SchemaVersion or ProductionOutboxRecoveryOptions.SchemaVersion or EvidenceReconciliationStoreOptions.SchemaVersion ? _options.ProductionInspections : null,
            ...
            if (ImageEvidenceEnabled && version is ProductionImageEvidenceStoreOptions.SchemaVersion or ProductionOutboxStoreOptions.SchemaVersion or ProductionOutboxRecoveryOptions.SchemaVersion or EvidenceReconciliationStoreOptions.SchemaVersion or
