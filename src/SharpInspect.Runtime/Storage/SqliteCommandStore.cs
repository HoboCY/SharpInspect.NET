...
internal sealed partial class SqliteCommandStore : ICommandAuditWriter, IAsyncDisposable
{
    ...
    private int SchemaVersion => StorageRetentionEnabled ? TraceStorageRetentionOptions.SchemaVersion :
    ...
    private string MigrationReason(int existingVersion) => StorageRetentionEnabled
        ...
        StoreDeadline? maintenanceDeadline = null, bool configureProfile = true)
    {
        ...
        if (_policy is not null)
        {
            ...
            if (ImageEvidenceEnabled && version is ProductionImageEvidenceStoreOptions.SchemaVersion or ProductionOutboxStoreOptions.SchemaVersion or ProductionOutboxRecoveryOptions.SchemaVersion or EvidenceReconciliationStoreOptions.SchemaVersion or TraceStorageRetentionOptions.SchemaVersion or
        ...
        if (version is EvidenceReconciliationStoreOptions.SchemaVersion or TraceStorageRetentionOptions.SchemaVersion)
