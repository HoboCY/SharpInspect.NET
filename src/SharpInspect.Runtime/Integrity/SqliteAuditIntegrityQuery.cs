        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            StationQualificationReadGuard.RequireVerified(db, report, deadline, _options);
                ...
                if (schema is ProductionArmStoreOptions.SchemaVersion or RecipeLifecycleStoreOptions.SchemaVersion or ProductionImageEvidenceStoreOptions.SchemaVersion)
