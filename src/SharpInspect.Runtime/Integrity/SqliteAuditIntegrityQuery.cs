        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var result = await Task.Run(() =>
            {
                ...
                AuditChainDatabase.Require(schema is 2 or 3 or 4 or 5 or 6 or 7 or 8 or 9 or 10 or 11 or 12 or 13 or 14 or 15 or 16 or 17 or 18 or 19 or 20 or 21 or 22 or 23,
                ...
                var cameraSchema = (schema is CameraSetupStoreOptions.SchemaVersion or CameraRecoveryStoreOptions.SchemaVersion or
                    ...
                    RecipeActivationStoreOptions.SchemaVersion or PreviewSessionStoreOptions.SchemaVersion or
                     CalibrationImportStoreOptions.SchemaVersion or ManualInspectionStoreOptions.SchemaVersion or
                     ProductionAdmissionStoreOptions.SchemaVersion or StationQualificationStoreOptions.SchemaVersion) && _options.CameraSetup is not null;
                ...
                var governanceSchema = (schema is CalibrationGovernanceStoreOptions.SchemaVersion or
                    ...
                    RecipeActivationStoreOptions.SchemaVersion or PreviewSessionStoreOptions.SchemaVersion or
                     CalibrationImportStoreOptions.SchemaVersion or ManualInspectionStoreOptions.SchemaVersion or
                     ProductionAdmissionStoreOptions.SchemaVersion or StationQualificationStoreOptions.SchemaVersion) && _options.CalibrationGovernance is not null;
                ...
                var contractSchema = schema is ManualInspectionStoreOptions.SchemaVersion or
                    ...
                    : schema is PlcResultContractStoreOptions.SchemaVersion or
                         RecipeActivationStoreOptions.SchemaVersion or PreviewSessionStoreOptions.SchemaVersion or
                         CalibrationImportStoreOptions.SchemaVersion or ProductionAdmissionStoreOptions.SchemaVersion or StationQualificationStoreOptions.SchemaVersion;
                ...
                var importSchema = schema is ManualInspectionStoreOptions.SchemaVersion or
                    ...
                    : schema is CalibrationImportStoreOptions.SchemaVersion or ProductionAdmissionStoreOptions.SchemaVersion or StationQualificationStoreOptions.SchemaVersion;
                ...
                var productionAdmissionSchema = schema == ProductionAdmissionStoreOptions.SchemaVersion ||
                    (schema == StationQualificationStoreOptions.SchemaVersion && _options.ProductionAdmission is not null);
