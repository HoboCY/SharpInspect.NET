...
internal static partial class AuditChainDatabase
{
        ...
        ProductionImageEvidenceStoreOptions options, StoreDeadline deadline)
    {
        Require(Scalar(database, "PRAGMA user_version;", deadline) is
            ProductionImageEvidenceStoreOptions.SchemaVersion or ProductionImageFinalizationStoreOptions.SchemaVersion or ProductionOutboxStoreOptions.SchemaVersion or ProductionOutboxRecoveryOptions.SchemaVersion
            or ProductionOutboxStoreOptions.SchemaVersion or ProductionOutboxRecoveryOptions.SchemaVersion,
