...
internal static partial class AuditChainDatabase
{
        ...
        long storedSchemaVersion, ProductionOutboxStoreOptions? outboxOptions, StoreDeadline deadline)
    {
        ...
        if (storedSchemaVersion < ProductionOutboxStoreOptions.SchemaVersion ||
            storedSchemaVersion is (EvidenceReconciliationStoreOptions.SchemaVersion or TraceStorageRetentionOptions.SchemaVersion or DiagnosticSupportStoreOptions.SchemaVersion) && outboxOptions is null)
        {
        ...
        StoreDeadline deadline)
    {
        Require(Scalar(database, "PRAGMA user_version;", deadline) is
            ProductionOutboxStoreOptions.SchemaVersion or ProductionOutboxRecoveryOptions.SchemaVersion or EvidenceReconciliationStoreOptions.SchemaVersion or TraceStorageRetentionOptions.SchemaVersion or DiagnosticSupportStoreOptions.SchemaVersion,
    ...
    {
        Require(Scalar(database, "PRAGMA user_version;", deadline) is (37 or 38 or 39 or DiagnosticSupportStoreOptions.SchemaVersion) && options.RecoveryEnabled,
