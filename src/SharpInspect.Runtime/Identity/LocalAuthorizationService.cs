...
internal sealed partial class LocalAuthorizationService : IIdentityAdministrationQuery, IStepUpAuthentication, IDisposable
{
    ...
    private static Permission RequiredPermission(RuntimeCommand command) => command switch
    {
        ...
        AbandonRecipeDraftCommand => Permission.AbandonRecipeDraft,
        RetireReleasedRecipeCommand => Permission.RetireRecipe,
    ...
    private StepUpBinding Binding(RuntimeCommand command) => new(RequiredPermission(command), command.CorrelationId,
        command switch
        {
            ...
            AbandonRecipeDraftCommand abandon => abandon.AuthorizationTarget,
            RetireReleasedRecipeCommand retire => retire.AuthorizationTarget,
    ...
    private static Permission PermissionForKind(AuditedCommandKind kind) => kind switch
    {
        ...
        AuditedCommandKind.AbandonRecipeDraft => Permission.AbandonRecipeDraft,
        AuditedCommandKind.RetireReleasedRecipe => Permission.RetireRecipe,
    ...
    private static AuditedCommandKind CommandKind(RuntimeCommand command) => command switch
    {
        ...
        ImportCalibrationPackageCommand => AuditedCommandKind.ImportCalibrationPackage,
        RevalidateImportedCalibrationCommand => AuditedCommandKind.RevalidateImportedCalibration,
        ...
        AbandonRecipeDraftCommand => AuditedCommandKind.AbandonRecipeDraft,
        RetireReleasedRecipeCommand => AuditedCommandKind.RetireReleasedRecipe,
